...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.setOutput('version', yield (0, version_1.getLatest)(crate, registry));
        }
        catch (error) {
...
function getLatest(crate, registry) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const versions = lines.filter(l => !!l).map(line => {
        ...
        return semver_1.default.sort(versions).reverse()[0];
    });
}
